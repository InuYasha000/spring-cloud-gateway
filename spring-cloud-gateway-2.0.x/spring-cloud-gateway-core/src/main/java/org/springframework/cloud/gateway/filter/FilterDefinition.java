...
public class FilterDefinition {
    ...
    /**
     * 参数数组
	 * 过滤器定义名字。通过 name 对应到 {@link GatewayFilterFactory} 的实现类
	 * 比如 name=AddRequestParameter 对应到 {@link AddRequestParameterGatewayFilterFactory}
     */
